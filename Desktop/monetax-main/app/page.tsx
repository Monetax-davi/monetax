    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <section style={{
        ...
        <div style={{ marginBottom: 40, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <img
            src="/logo-monetax.jpg"
            alt="MonetaX"
            style={{ width: 72, height: 72, borderRadius: 18, objectFit: 'cover', boxShadow: '0 0 32px rgba(26,108,255,0.35)' }}
          />
        </div>
        ...
        {user && (
          <div style={{ marginTop: 24 }}>
            <Link href="/dashboard" style={{
              ...
              background: 'rgba(26,108,255,0.12)', border: '1px solid rgba(26,108,255,0.3)',
              color: 'var(--blue-light)', fontWeight: 600, fontSize: 14, textDecoration: 'none',
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <img src="/logo-monetax.jpg" alt="MonetaX" style={{ width: 32, height: 32, borderRadius: 8, objectFit: 'cover' }} />
        ...
        <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', alignItems: 'center' }}>
          <a
            href="https://www.instagram.com/monetax.br/"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: 'var(--text-muted)', fontSize: 13, textDecoration: 'none', fontWeight: 500 }}
          >
            @monetax.br
          </a>
          {[['Política de Privacidade', '/privacidade'], ['Termos de Uso', '/termos'], ['Contato', '/contato']].map(([l, h]) => (
