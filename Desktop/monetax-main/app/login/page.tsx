...
function AuthContent() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (modo === 'cadastro') {
      ...
      // Sem email confirmation — usuário já está logado, vai pro onboarding
      if (data.session) {
      ...
      // LOGIN — verifica se já fez onboarding para não repetir
      ...
      if (data.user) {
        ...
        // Usuário existente com onboarding feito → dashboard direto
        // Usuário novo ou sem onboarding → onboarding
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <a href="/" style={{
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          gap: 12, marginBottom: 36, textDecoration: 'none'
        }}>
          <img
            ...
            style={{
              ...
              boxShadow: '0 0 24px rgba(26,108,255,0.45)'
            }}
          />
