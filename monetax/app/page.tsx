    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          {user ? (
            <Link href="/dashboard" style={{
              padding: '10px 22px', borderRadius: 10, background: 'var(--blue)',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <span style={{ color: 'var(--blue-light)', fontSize: 13, fontWeight: 500 }}>IA financeira para quem tem dívidas</span>
        </div>
        ...
        <p style={{
          ...
          O MonetaX usa IA para criar seu plano financeiro personalizado — do controle das dívidas até a construção de patrimônio.
        </p>
        ...
        <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', justifyContent: 'center' }}>
          <Link href="/login?modo=cadastro" style={{
            ...
            boxShadow: '0 0 30px rgba(26,108,255,0.35)',
            transition: 'all 0.2s'
          }}>
      ...
      <section id="como-funciona" style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
          {[
            ...
            { fase: 'D', titulo: 'Direção', desc: 'Receba um plano personalizado com metas realistas para quitar dívidas e criar reservas.', cor: 'var(--blue)' },
      ...
      <section style={{ padding: '80px 24px', textAlign: 'center' }}>
        <div style={{
          ...
          background: 'var(--bg-card)', border: '1px solid rgba(26,108,255,0.2)',
          borderRadius: 24
        }}>
          ...
          <Link href="/login?modo=cadastro" style={{
            ...
            color: '#fff', fontWeight: 700, fontSize: 16, textDecoration: 'none',
            fontFamily: 'Syne, sans-serif', letterSpacing: '-0.3px',
            boxShadow: '0 0 40px rgba(26,108,255,0.3)'
          }}>
            ⚡ Começar grátis agora
          </Link>
        </div>
